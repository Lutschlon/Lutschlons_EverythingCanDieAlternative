###### Version 1.1.32 - Changed the framework for mod compatibilities, added beta compatibility for LethalHands by SlapItNow
###### Version 1.1.31 - Uploaded the correct files
## Version 1.1.3
