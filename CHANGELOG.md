...
- Updated how Hits are detected, now nativley works with HexiBetterShotgun
- Added combatibility with LethalMin
...
- Ported the mod from .Net v4.7.2 to netstandard2.1
- Updated Changelog
